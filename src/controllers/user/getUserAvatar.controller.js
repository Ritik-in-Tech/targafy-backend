...
const getUserAvatarByUserId = asyncHandler(async (req, res, next) => {
  try {
    const userId = req.params.userId;
    if (!userId) {
      return res
        .status(400)
        .json(new ApiResponse(400, {}, "UserId not provided in params"));
    }
...
export { getUserAvatar, getUserAvatarByUserId };
